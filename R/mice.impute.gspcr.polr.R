#' Imputation by generalized supervised principal component proportional odds regression.
#'
#' Imputes univariate missing values on an ordered categorical variable using generalized supervised principal component proportional odds regression.
#'
...
#' @keywords imputation
#' @export
mice.impute.gspcr.polr <- function(y, ry, x, wy = NULL,
                                   thrs = "PR2",
                                   fit_measure = "BIC",
                                   nthrs = 10,
                                   npcs_range = 1:3,
